            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between">
                    ...
                    <a class="navbar-brand d-flex align-items-center color-900" href="index.html">
                        ...
                        <span class="h4 mb-0 fw-bold ps-2">avio</span>
                    </a>
                                            ...
                                            <div class="row g-2">
                                                ...
                                                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-6">
                                                    <div class="row g-2 row-deck">
                                                        ...
                                                        <div class="col-6">
                                                            <div class="card bg-light-warning lift">
                                                                <a href="docs/doc-helperclass.html" class="card-body">
                                ...
                                <div class="dropdown-menu border-0 rounded-4 shadow p-0">
                                    <div class="card w240 overflow-hidden">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted"><a href="https://wrraptheme.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="3d5c515154585a4f5c49584f7d5c4b5452135e5250">[email&#160;protected]</a></p>
                        ...
                        <div class="card shadow rounded-4 search-result slidedown">
                            <div class="card-body">
                                ...
                                <div class="card list-group list-group-flush list-group-custom mt-2">
                                    <a class="list-group-item list-group-item-action text-truncate" href="https://wrraptheme.com/docs/doc-helperclass.html">
                                    ...
                                    <a class="list-group-item list-group-item-action text-truncate" href="https://wrraptheme.com/docs/element-daterange.html">
                                    ...
                                    <a class="list-group-item list-group-item-action text-truncate" href="https://wrraptheme.com/docs/element-imageinput.html">
                                    ...
                                    <a class="list-group-item list-group-item-action text-truncate" href="https://wrraptheme.com/docs/plugin-table.html">
                                        <div class="fw-bold">DataTables for jQuery</div>
                                        <small class="text-muted">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</small>
                                    </a>
                                    <a class="list-group-item list-group-item-action text-truncate" href="https://wrraptheme.com/docs/doc-setup.html">
                ...
                <div class="row">
                    <div class="col-12 mb-2">
                        <ol class="breadcrumb mb-2">
                            <li class="breadcrumb-item"><a href="https://wrraptheme.com/templates/avio/index.html">Avio</a></li>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="page-action">
                                ...
                                <a class="btn d-none d-sm-inline-flex bg-secondary rounded-pill" href="https://themeforest.net/item/avio-bootstrap-5-admin-dashboard-template/38247427" target="_blank" title="">
                        ...
                        <div class="ph-tab">
                            ...
                            <section>
                                ...
                                <div class="tab1 rounded-4">
                                    ...
                                    <script data-cfasync="false" src="../../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="assets/js/bundle/owlcarousel.bundle.js"></script>
                                    <script>
                                        var owl = $('.owl_summary');
                                        owl.owlCarousel({
                                            items: 4,
