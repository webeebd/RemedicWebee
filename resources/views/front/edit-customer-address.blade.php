        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <div class="main__wrapper">
                    ...
                    <div class="checkout__form mb-50" id='add-address'>
                        <div class="dashboard__title dashboard__title--v2">
                            <h4 class="title">Update Address</h4>
                        </div>
                        <form action="{{url('/update-address')}}" class="form__wrapper form-padding" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="flex__form c-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address_house" id="f_name" class="form-control"
                                           placeholder="House/Flat No" value="{{$address->address_house}}"/>
                                </div>
                                <div class="form-group">
                                    <label for="f_name">Street Name</label>
                                    <input type="text" name="address_street" id="f_name" class="form-control"
                                           placeholder="Street Name" value="{{$address->address_street}}"/>
                                </div>
                            </div>
                            <div class="flex__form c-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="area" id="f_name" class="form-control"
                                           placeholder="Enter Area" value="{{$address->area}}" />
                                </div>
                                <div class="form-group">
                            ...
                            <div class="btn__group">
                                <button type="submit" class="btn btn-gray-filled">Update</button>
                            </div>
                        </form>
                     </div>
                    <!-- Profile Table Start -->
