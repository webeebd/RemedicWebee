<template>
    <div class="container-fluid">
        ...
        <div class="menu-link flex-fill">
            <div class="dropdown menu-home" v-if="this.accessRole.indexOf('Dashboard') !== -1">
                <router-link class="btn btn-link" to="/admin/home">
                ...
                <span style="padding-left:6px;"> Dashboard</span></router-link>
            </div>
            <div class="dropdown menu-pages">
                    ...
                    <ul class="dropdown-menu p-2 shadow animation_delay">
                        ...
                        <ul class="dropdown-menu border-0 p-2 shadow-lg animation_delay">
                            <li v-if="this.accessRole.indexOf('Roles') !== -1"><router-link to="/admin/roles" class="dropdown-item">Manage Roles</router-link></li>
                            <li v-if="this.accessRole.indexOf('Permissions') !== -1"><router-link to="/admin/permissions/all" class="dropdown-item">Manage Permissions</router-link></li>
                            <li v-if="this.accessRole.indexOf('Create Users') !== -1"><router-link to="/admin/users" class="dropdown-item">Manager User</router-link></li>
                        </ul>
                        </li>

                                             
                        <li v-if="this.accessRole.indexOf('Brand') !== -1"><router-link class="dropdown-item" to="/admin/brands"><span>Brand</span></router-link></li>
                        <li v-if="this.accessRole.indexOf('Categories') !== -1"><router-link class="dropdown-item" to="/admin/categories"><span>Categories</span></router-link></li>
                        <li v-if="this.accessRole.indexOf('Departments') !== -1"><router-link class="dropdown-item" to="/admin/departments"><span>Department</span></router-link></li>
                        
                        <li v-if="this.accessRole.indexOf('AMC Master') !== -1"><router-link class="dropdown-item" to="/admin/amc-master"><span>AMC Master</span></router-link></li>
                        <li v-if="this.accessRole.indexOf('Discount') !== -1"><router-link class="dropdown-item" to="/admin/discount-master"><span>Discount Master</span></router-link></li>
                        <li class="dropdown-submenu">
                        <a href="#" data-bs-toggle="dropdown" class="dropdown-item d-flex dropdown-toggle after-none">
                        <span>Products</span>
                        <svg class="ms-auto" width="18" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <ul class="dropdown-menu border-0 p-2 shadow-lg animation_delay">
                            <li v-if="this.accessRole.indexOf('Create Products') !== -1"><a href="/admin/add-products" class="dropdown-item">Add New Product</a></li>
                            <li v-if="this.accessRole.indexOf('Update Products') !== -1"><router-link to="/admin/products" class="dropdown-item">Manage Products</router-link></li>
                            <li v-if="this.accessRole.indexOf('View Inventory') !== -1 || this.accessRole.indexOf('Update Inventory') !== -1"><router-link to="/admin/inventory" class="dropdown-item">Manage Inventory</router-link></li>
                        </ul>
                        </li>
                        <li v-if="this.accessRole.indexOf('Customers') !== -1"><router-link class="dropdown-item" to="/admin/customers"><span>Customers</span></router-link></li>
                        
                    </ul>
            </div>
            <div class="dropdown menu-orders" v-if="this.accessRole.indexOf('View Orders') !== -1">
                    <router-link class="btn btn-link" to="/admin/orders"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="fill-muted" class="bi bi-box" viewBox="0 0 16 16">
                    <ellipse class="fill-secondary" cx="5.42825" cy="4.59252" rx="2.85696" ry="2.96255"></ellipse>
                    <path d="M8.186 1.113a.5.5 0 0 0-.372 0L1.846 3.5 8 5.961 14.154 3.5 8.186 1.113zM15 4.239l-6.5 2.6v7.922l6.5-2.6V4.24zM7.5 14.762V6.838L1 4.239v7.923l6.5 2.6zM7.443.184a1.5 1.5 0 0 1 1.114 0l7.129 2.852A.5.5 0 0 1 16 3.5v8.662a1 1 0 0 1-.629.928l-7.185 2.874a.5.5 0 0 1-.372 0L.63 13.09a1 1 0 0 1-.63-.928V3.5a.5.5 0 0 1 .314-.464L7.443.184z"/>
                    </svg>
                    <span style="padding-left:6px;"> Orders</span></router-link>
            </div>

            <div class="dropdown menu-amc" v-if="this.accessRole.indexOf('View AMC') !== -1 || this.accessRole.indexOf('Update AMC') !== -1">
                    <router-link class="btn btn-link" to="/admin/amc" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="fill-muted" class="bi bi-gear" viewBox="0 0 16 16">
                    <ellipse class="fill-secondary" cx="5.42825" cy="4.59252" rx="2.85696" ry="2.96255"></ellipse>
                    ...
                    <span style="padding-left:6px;"> AMC</span></router-link>
            </div>
            ...
            <div class="dropdown menu-reports">
                <a href="#" class="btn btn-link dropdown-toggle after-none" data-bs-toggle="dropdown"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="fill-muted" class="bi bi-clipboard-data" viewBox="0 0 16 16">
                    ...
                    <ul class="dropdown-menu p-2 shadow animation_delay">                        
                        <li><router-link class="dropdown-item" to="/admin/report/customer"><span>Customer Report</span></router-link></li>
                        <li><router-link class="dropdown-item" to="/admin/report/booking"><span>Booking Report</span></router-link></li>
                        <li><router-link class="dropdown-item" to="/admin/report/cancelled"><span>Cancelled Report</span></router-link></li>
                        <li><router-link class="dropdown-item" to="/admin/report/return"><span>Order Return Report</span></router-link></li>
                        <li><router-link class="dropdown-item" to="/admin/report/revenue"><span>Revenue Report</span></router-link></li>
                        <li><router-link class="dropdown-item" to="/admin/report/inventory"><span>Inventory Report</span></router-link></li>
                    </ul>
            </div>
            </div>  
            <ul class="navbar-right d-flex align-items-center mb-0 list-unstyled">
                ...
                <div class="card-body">
                <h6 class="card-title mb-0">{{this.authName}}</h6>
                ...
                <router-link to="/admin/profile" class="list-group-item list-group-item-action border-0"><i class="w30 fa fa-user"></i>Profile &amp; account</router-link>
                <router-link to="/admin/feedback" class="list-group-item list-group-item-action border-0"><i class="w30 fa fa-gear"></i>Feedback</router-link>
                </div>
                </div>
                </div>
                </div>
...
<script>
    export default {
        props: ['accessRole','authName','authEmail']
    }
</script>