                ...
                <div class="col-xxl-12 col-xl-12 col-lg-12">
                    <div class="card bg-transparent border-0">
                        <div class="row g-3">
                            ...
                            <div class="col-12" v-if="!this.isActive">
                                <div class="card">
                                    <div class="card-body text-center p-5">
                                        ...
                                        <button type="button" class="btn btn-white border lift" @click="$router.push('/admin/kpi')">Choose your KPIs</button>
                                        <button type="button" class="btn btn-primary border lift" style="margin-left:10px;" @click="defaultKpis()">Keep default KPIs</button>
                                    </div>
                                </div>
                            </div>   
    ...
    export default {
        ...
        mounted(){
            $(document).ready(function(){
                var sparklineData = [0, 0, 0, 0, 0, 0, 0];
                // topb big chart    
                var spark1 = {
                    chart: {
                    type: 'area',
                ...
                var spark1 = new ApexCharts(document.querySelector("#apex_c_1"), spark1);
                spark1.render();
                ...
                var spark2 = new ApexCharts(document.querySelector("#apex_c_2"), spark2);
                spark2.render();
                ...
                var spark3 = new ApexCharts(document.querySelector("#apex_c_3"), spark3);
                spark3.render();
                ...
                var spark4 = new ApexCharts(document.querySelector("#apex_c_4"), spark4);
                spark4.render();
